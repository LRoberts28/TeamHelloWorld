...
public class HrMain {
    ...
    public static void SetUp()
    {
        ...
        TempArrays.addUser(new Person("Stuart Thea", 55, "SThea1@msu.net", "password"));
        TempArrays.addUser(new Person("Mason Myers", 31, "MMyers1@msu.net", "password"));
        TempArrays.addUser(new Person("Sam Cromwell", 47, "SCromwell1@msu.net", "password"));
        TempArrays.addUser(new Person("Tyler Reed", 21, "TReed1@msu.net", "password"));
        TempArrays.addUser(new Person("Madison Rowe", 21, "MRowe1@msu.net", "password"));
    }
}
